/*Name: Vensan Cabardo
  ...
  Description: Header file that holds the prototypes for the symbol table functions and the symbtab structure
*/
...
struct SymbTab
{
     ...
     int IsAFunc;  /* the element is a function 0 - scalar ; 1 - array ; 2 - function */
